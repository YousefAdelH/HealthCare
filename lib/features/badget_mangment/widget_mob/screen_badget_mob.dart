...
class ScreenBadgetMob extends StatelessWidget {
  const ScreenBadgetMob({Key? key}) : super(key: key);
                                ...
                                TableRow(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: CustomText(
                                        text: S.of(context).totalPricePatient,
                                        textAlign: TextAlign.center,
                                ...
                                TableRow(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: CustomText(
                                        text: S.of(context).totalPriceExpenses,
                                        textAlign: TextAlign.center,
                                        fontWeight: FontWeight.w500,
                                        color: AppColors.black,
                                        size: 15.sp,
                                ...
                                TableRow(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: CustomText(
                                        text: S.of(context).totalPriceMaterial,
                                        textAlign: TextAlign.center,
                                        fontWeight: FontWeight.w500,
                                        color: AppColors.black,
                                        size: 15.sp,
                              ...
                              PieChartData(
                                sections: [
                                  PieChartSectionData(
                                    ...
                                    color: AppColors.blue2,
                                    title: con.totalpatientprice.value == 0
                                        ? S.of(context).zeroPercent
                                        : con.calculatePercentage(
                                            con.totalpatientprice.value),
                                  ),
                                  PieChartSectionData(
                                    titlePositionPercentageOffset: 0.55,
                                    color: AppColors.blue3,
                                    title: con.totalExpensesPrice.value == 0
                                        ? S.of(context).zeroPercent
                                        : con.calculatePercentage(
                                            con.totalExpensesPrice.value),
                                  ),
                                  PieChartSectionData(
                                    titlePositionPercentageOffset: 0.55,
                                    color: AppColors.blue4,
                                    title: con.totalTransactionPrice.value == 0
                                        ? S.of(context).zeroPercent
                                        : con.calculatePercentage(
                                            con.totalTransactionPrice.value),
                                  ),
                                  PieChartSectionData(
                                    titlePositionPercentageOffset: 0.55,
                                    color: AppColors.matchblue,
