...
class ShowAddUpdateNewsessionMob extends StatelessWidget {
  final String id;

  final bool isEditMode;
  final String? sessionId;
  ShowAddUpdateNewsessionMob({
    super.key,
    required this.id,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CustomLargeButton(
                        primeColor: AppColors.black,
                        backColor: AppColors.whiteff,
                        onPressed: () {
                          if (sessionId == null) {
                            con.addSession(context, id);
                          } else {
                            con.updateSession(context, id, sessionId!);
                          }
                    ...
                    Padding(
                      padding: const EdgeInsets.all(15.0),
                      child: CustomLargeButton(
                        primeColor: AppColors.whiteff,
                        backColor: AppColors.reject,
                        onPressed: () async {
                          bool shouldClearData = await con
                              .showClearDataConfirmationDialog(context);
                          if (shouldClearData) {
                            con.clearsession();
                            Navigator.of(context).pop();
                          }
